  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex min-h-[11rem] flex-1 flex-col p-4">
...
function FilesByQrCard() {
  return (
    <Link
      ...
      className="group grid overflow-hidden rounded-[20px] border border-[#CBD5E1] bg-white shadow-[0_1px_3px_rgba(16,24,40,0.04)] transition-all duration-200 hover:-translate-y-0.5 hover:border-[#94A3B8] hover:shadow-[0_12px_28px_rgba(16,24,40,0.08)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF3B30] focus-visible:ring-offset-2 lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)]"
    >
      <ToolImage
        src={resourceDropArt}
        alt="Files by QR file sharing"
        icon={QrCode}
        className="aspect-[4/3] bg-[#F6F7F9] lg:aspect-auto lg:min-h-0"
      />
